	...
	<form method="post" enctype="multipart/form-data" class="review-form">
		...
		<div class="input-wrapper">
			<div class="flex justify-between item-baseline py-10">
				<div class="rating">
					<select name="rating" class="rating-select" data-rating="${item.rating}">
			...
			<div class="text-center py-15">
				<textarea class="contents" name="contents" placeholder="리뷰에 관한 이야기를 작성해주세요" required>${item.contents}</textarea>
			</div>
			<div class="text-right">
				<button class="btn black round px-40 font-size-small" id="review-submit">리뷰 수정</button>
			</div>
		</div>
	</form>
