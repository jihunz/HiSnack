			...
			<div class="flex justify-center">
				<div class="signupbox text-center mt-120">
					...
					<form class="signupForm">
						...
						<div>
							<h4 class="signupfont mt-60 text-center">비밀번호 찾기</h4>
							...
							<div>
								...
								<div class="flex item-center">
									<input type="text" name="id" id="userId" placeholder="ID" maxlength="32"
										class="addressinput">
									<button type="button" id="id-confirm-btn" class="addressbtn text-center">아이디
										확인</button>
								</div>
							</div>
								...
								<div>
									...
									<div class="flex item-center">
										<div id="email-confirm-wrapper">
											<input type="text" id="email-confirm" placeholder="Email Confirm"
												maxlength="32" class="addressinput" readonly />
											<span></span>
										</div>
										<button type="button" id="email-confirm-btn"
											class="addressbtn text-center">확인</button>
									</div>
								</div>
							</div>
